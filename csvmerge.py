...
directory = "/Users/wiktoria/Documents/master/Master thesis/January 27, 2010 - iPad announcement"  # Replace with your actual path

# Define the output file path
output_file = "January_27_2010_merged.csv"  # You can change the output filename if needed
