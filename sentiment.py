...
csv_file = '/Users/wiktoria/Documents/master/Master thesis/All tweets/ALL TWEETS_merged_links+apple+query+nick+dup+ASCII+lowercase+stopwords+lemmatization.csv'
